...
# as a tuple ↴ of integers (start_time, end_time). These integers represent the number of 30-minute
# blocks past 9:00am.
...
# Write a function merge_ranges() that takes a list of multiple meeting time ranges and returns
...
# timestamps. In any case, the spirit of the challenge is to merge meetings where start_time
